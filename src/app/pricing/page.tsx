          ...
          <div className="max-w-3xl mb-12">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-signal-500/15 border border-signal-500/25">
                <DollarSign size={20} className="text-signal-400" />
              </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-void-800/60">
                    {cheapestPlan && (
                      <span className="text-xs text-void-500">
                        Starting at <span className="text-signal-400 font-semibold">{cheapestPlan.price}{cheapestPlan.period.includes('month') ? '/mo' : ''}</span>
                      </span>
                    )}
                    <span className="flex items-center gap-1 text-sm font-semibold text-signal-400 group-hover:text-signal-300 transition-colors">
