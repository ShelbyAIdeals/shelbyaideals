    ...
    <main>
      ...
      <section id="categories" className="py-16 sm:py-20">
        <div className="container-main">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 animate-reveal-stagger">
      ...
      {featuredReviews.length > 0 && (
        <section className="py-16 sm:py-20">
          <div className="container-main">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 animate-reveal-stagger">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 animate-reveal-stagger">
              {latestComparisons.map((comp) => (
                <Link
                  ...
                  className="card group p-6 no-underline hover:-translate-y-1 transition-all"
                >
                  {/* Tool badges */}
