...
![Claude Code running in the terminal](/images/guides/how-to-use-claude-code-2.webp)
*Claude Code runs right in your terminal — you describe what you want in plain language and it plans, edits files, and runs commands.*
...
![The Claude Code desktop app](/images/guides/how-to-use-claude-code-3.webp)
*Beyond the terminal, Claude Code also ships as a desktop app with visual diff review and parallel sessions — plus IDE and web versions that share the same settings.*
