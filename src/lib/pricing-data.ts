...
export const pricingData: PricingPage[] = [
  // ── Jasper AI Pricing ──────────────────────────────────
  {
    ...
    plans: [
      {
        ...
        description: 'For individual creators and freelancers who need AI writing assistance.',
        features: [
          '1 user seat',
      ...
      },
      {
        ...
        price: '$69',
        period: '/month (billed annually)',
        description: 'For small teams that need collaboration and more advanced features.',
        features: [
          'Up to 3 user seats',
      ...
      },
      {
        ...
        description: 'For larger teams and enterprises needing full platform control.',
        features: [
    ...
    faqs: [
      { question: 'Does Jasper AI offer a free trial?', answer: 'Yes, Jasper offers a 7-day free trial on Creator and Pro plans. No credit card required to start, though you will need one to continue after the trial.' },
      { question: 'Is Jasper AI worth the price?', answer: 'For marketing teams and content creators who publish frequently, Jasper pays for itself quickly. The Creator plan at $49/mo is steep for casual users, but the time savings on content creation can justify the cost for professionals.' },
      { question: 'Can I cancel Jasper AI anytime?', answer: 'Yes. Monthly plans can be cancelled anytime. Annual plans are billed upfront and cannot be refunded mid-term, but you keep access until the billing period ends.' },
      { question: 'What is the cheapest Jasper AI plan?', answer: 'The Creator plan at $49/month (billed annually) is the most affordable option. There is no free plan — only a 7-day trial.' },
    ],
  },
